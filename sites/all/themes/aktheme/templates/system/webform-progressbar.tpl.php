 ...
 */
?>
<?php if ($progressbar_bar){ //Custom progress bar?>
<div class="steps row">
    <?php for ($n = 1; $n <= $page_count; $n++) { ?>
  <div class="col-sm-<?php print ceil(12/$page_count) ?> step <?php if ($n < $page_num) { print ' completed'; } if ($n == $page_num) { print ' active'; } ?>">
    <div class="content">
      <?php if ($progressbar_pagebreak_labels){ ?>
          <i class="fa fa-check" aria-hidden="true"></i><span class="webform-progressbar-page-label">
...
<?php if(FALSE) { //Hide original progress bar?>
