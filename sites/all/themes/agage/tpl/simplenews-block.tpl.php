...
<div class="container">
  	<div class="row row-padding">
     	<div class="col-md-8 col-md-offset-2 text-center wow fadeIn" data-wow-delay=".4s" data-wow-duration=".8s">
        	<p class="font25 lh-nm"><?php print t('Stay informed with our newsletter');?></p>
			<?php if ($message): ?>
                <h2 class="text-uppercase"><?php print $message; ?></h2>
            <?php endif; ?>
            
            <?php if ($use_form): ?>
                <div class="col-sm-8 col-sm-offset-2 marT30">
                    <?php print render($form); ?>
                </div>
            <?php endif; ?>
            <div class="form-tip col-sm-12">
                <p class="lh-nm">
                    <i class="fa fa-info-circle"></i>
                    <?php print t('Please trust us, we will never send you spam');?>
                </p>
            </div>
        </div>
    </div>
